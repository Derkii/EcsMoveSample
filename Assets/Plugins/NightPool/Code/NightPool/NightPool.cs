...
namespace Plugins.NightPool.Code.NightPool
{
    public static class NightPool
    {
        ...
        {
            return
                DefaultSpawn(component.gameObject, position, rotation, null, false).GetComponent<T>();
        }
            ...
            bool worldStaysPosition = false) where T : Component
        {
            ...
            return
                DefaultSpawn(component.gameObject, position, rotation, parent, worldStaysPosition).GetComponent<T>();
        }
